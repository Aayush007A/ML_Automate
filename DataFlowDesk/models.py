...
class Dataset(models.Model):
    ...
    cleaned_file = models.FileField(upload_to='datasets/cleaned/', null=True, blank=True)
    status = models.CharField(max_length=50, choices=[('pending', 'Pending'), ('processed', 'Processed')], default='pending')
    graphs = models.JSONField(default=list, blank=True)
    target_class = models.CharField(max_length=255, null=True, blank=True)
    dataset_type = models.CharField(max_length=255, null=True, blank=True)
